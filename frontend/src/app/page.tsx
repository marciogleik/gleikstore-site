    ...
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8 animate-fade-in-up">
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-gray-400">Novidades disponíveis</span>
            </div>
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-md mx-auto lg:mx-0 mb-8 leading-relaxed animate-fade-in-up animate-delay-200">
              Aparelhos selecionados a dedo, revisados por especialistas e entregues com garantia real.
              Sem surpresas, sem dor de cabeça.
            </p>
            ...
            <div className="flex items-center gap-6 mt-10 justify-center lg:justify-start animate-fade-in-up animate-delay-400">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500">Garantia 90 dias</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-emerald-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                <span className="text-xs text-gray-500">Testado e revisado</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-emerald-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
          ...
          <div className="flex-1 flex justify-center lg:justify-end animate-fade-in-up animate-delay-200">
            <div className="relative">
              ...
              <img
                src="/iphone-hero.png"
                alt="iPhone Premium"
                className="w-[320px] md:w-[400px] lg:w-[480px] drop-shadow-[0_0_80px_rgba(120,80,255,0.15)]"
              />
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white">4.9<span className="text-lg text-amber-400">★</span></p>
              <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Avaliação média</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white">99%</p>
              <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Satisfação</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white">2h</p>
              <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Tempo de resposta</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="py-24 px-6 relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <p className="text-xs uppercase tracking-[0.3em] text-violet-400 text-center mb-3">Processo simples</p>
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-4">
            Como funciona
          </h2>
          <p className="text-gray-500 text-center max-w-lg mx-auto mb-16">
            Em poucos passos você sai com o iPhone ideal, com total segurança e garantia.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.06] hover:border-white/10 transition-all duration-500">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Chame no WhatsApp e diga qual modelo procura. Sem robô, sem enrolação.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.06] hover:border-white/10 transition-all duration-500">
              ...
              <h3 className="text-lg font-semibold mb-2">Escolha com confiança</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
                Receba fotos reais, laudo técnico e todas as informações antes de fechar.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.06] hover:border-white/10 transition-all duration-500">
              ...
              <h3 className="text-lg font-semibold mb-2">Receba com garantia</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
                Aparelho em mãos com garantia de 90 dias, nota fiscal e suporte total.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto">
          <p className="text-xs uppercase tracking-[0.3em] text-emerald-400 text-center mb-3">Nossos diferenciais</p>
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">
            Por que a <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">GLEIKSTORE</span>?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <h3 className="font-semibold mb-1.5">Aparelhos certificados</h3>
              <p className="text-sm text-gray-500 leading-relaxed">Cada iPhone passa por 47 pontos de checagem antes de ser aprovado para venda.</p>
            </div>
            ...
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <h3 className="font-semibold mb-1.5">Garantia real de 90 dias</h3>
              <p className="text-sm text-gray-500 leading-relaxed">Não é promessa, é contrato. Se der problema, a gente resolve ou troca.</p>
            </div>
            ...
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <h3 className="font-semibold mb-1.5">Facilidade de pagamento</h3>
              <p className="text-sm text-gray-500 leading-relaxed">Pix, cartão, parcelamento. Condições que cabem no seu bolso.</p>
            </div>
            ...
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">Tudo documentado. Sua compra 100% segura e com respaldo legal.</p>
            </div>
            ...
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <h3 className="font-semibold mb-1.5">Pós-venda dedicado</h3>
              <p className="text-sm text-gray-500 leading-relaxed">A relação não acaba na venda. Suporte humano sempre que precisar.</p>
            </div>
            ...
            <div className="card-glow p-7 rounded-2xl bg-zinc-900/60 border border-zinc-800/60">
              ...
              <h3 className="font-semibold mb-1.5">Área de membros exclusiva</h3>
              <p className="text-sm text-gray-500 leading-relaxed">Acompanhe garantia, documentos e promoções pela nossa plataforma.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="max-w-5xl mx-auto">
          <p className="text-xs uppercase tracking-[0.3em] text-amber-400 text-center mb-3">O que dizem sobre nós</p>
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-white/[0.06]">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mb-4">
                &ldquo;Comprei meu iPhone 14 Pro e veio impecável. Atendimento nota 10, muito transparentes com tudo. Recomendo demais!&rdquo;
              </p>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-white/[0.06]">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mb-4">
                &ldquo;Minha mãe precisava de um iPhone bom e barato. A Gleikstore resolveu tudo rápido, com paciência e carinho. Voltarei com certeza!&rdquo;
              </p>
              <div className="flex items-center gap-3">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-white/[0.06]">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mb-4">
                &ldquo;Já é o terceiro aparelho que compro aqui. Preço justo, qualidade absurda e o Gleik é gente finíssima. Confiança total.&rdquo;
              </p>
              <div className="flex items-center gap-3">
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <p className="text-xs uppercase tracking-[0.3em] text-gray-500 mb-4">Pronto para o seu?</p>
          <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
            Seu iPhone perfeito está a uma{' '}
            <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">mensagem</span>{' '}
            de distância
          </h2>
          <p className="text-gray-500 max-w-lg mx-auto mb-10">
            Fale com a gente no WhatsApp. Sem compromisso, sem pressão. A gente encontra o aparelho ideal pra você.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
      ...
      <section className="py-20 px-6 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-500 leading-relaxed text-sm">
            Somos especialistas em iPhones seminovos e novos desde 2020. Nosso compromisso é oferecer
            aparelhos de qualidade premium com transparência total, garantia real e atendimento humano.
            Cada aparelho é cuidadosamente selecionado e testado para garantir sua satisfação.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-gray-600 mt-3 max-w-xs leading-relaxed">
                Tecnologia premium ao seu alcance. iPhones selecionados com rigor, garantia real e atendimento que faz a diferença.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-2.5">
                ...
                <a href="/login" className="block text-sm text-gray-600 hover:text-white transition-colors">Área de membros</a>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                ...
                <p className="text-sm text-gray-600">📍 Rua Treze, Bairro Operário</p>
                <p className="text-sm text-gray-600">🏢 62.282.270/0001-90</p>
              </div>
            </div>
          </div>

          <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-3">
            <span className="text-xs text-gray-700">© 2024 Gleikstore. Todos os direitos reservados.</span>
